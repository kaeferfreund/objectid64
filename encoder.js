const defaultBase = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_";
/**
...
class Encoder {
     ...
     */
    constructor(base = defaultBase, noLookup) {
        /**
         * The lookup table for converting base64 to hex
         */
        this.baseToHex = new Map();
        /**
         * The lookup table for converting hex to base64
         */
        this.hexToBase = new Map();
        this.base = base;
        if (!noLookup) {
            this.constructor.initialize(this.base, this.baseToHex, this.hexToBase);
        }
    }
    /**
    ...
    fromObjectId(objectId) {
        ...
        return (hexToBase.get(objectId.slice(0, 3)) +
    ...
    toObjectId(id) {
        ...
        return (baseToHex.get(id.slice(0, 2)) +
     ...
     */
    toBinObjectId(id, view = new Uint8Array(12)) {
        const { base } = this;
        let code = 0;
        let i = -1;
        let j = -1;
    ...
    fromUUID(uuid) {
        const { hexToBase } = this;
        return (hexToBase.get(uuid.slice(0, 3)) +
     ...
     */
    toBinUUID(id, view = new Uint8Array(16)) {
        const { base } = this;
        let code = 0;
        let i = -1;
        let j = -1;
